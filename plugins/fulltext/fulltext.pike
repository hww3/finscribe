...
{
  app->call_out(app->create_thread, 0, doUpdateIndex, event, id, obj);
...
{
  app->call_out(app->create_thread, 0, doUpdateIndexDelete, event, id, obj);
...
{
  app->call_out(app->create_thread, 0, doUpdateIndexMove, event, id, oldpath, obj);
